...
const ParagraphContent = memo(function ParagraphContent({
  ...
  if (!content)
    return isPreview ? null : (
      <span className="text-muted-foreground/50">Click to add text...</span>
    );
...
export const ParagraphBlock = memo(function ParagraphBlock({
  ...
  if (isPreview) {
    ...
    return (
      <p className={styles.canvasBlock} style={paraStyle}>
    ...
    <>
      <div style={{ position: "relative" }}>
        ...
        {!isEditing && (
          ...
          >
            <ParagraphContent content={block.content} isPreview={false} />
          </div>
        )}
        ...
        {isEditing && (
          <div
            ...
            onBlur={(e) => {
              ...
              const updates: Partial<ParagraphBlockProps> = {};
