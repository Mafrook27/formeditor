...
export interface BaseBlockProps {
  ...
  blockBorderStyle?: "none" | "solid" | "dashed" | "dotted";
...
export const BLOCK_LIBRARY: BlockLibraryItem[] = [
  ...
  },
  {
    ...
    label: "Text Input",
    category: BLOCK_CATEGORIES.FORM,
  ...
  switch (type) {
    ...
    case BLOCK_TYPES.PARAGRAPH:
      return {
        ...
        type,
        content:
          "Enter your text here. This paragraph block supports rich content for legal agreements, descriptions, and professional documents.",
        fontSize: 14,
        fontWeight: 400,
        textAlign: "left",
        lineHeight: 1.6,
    ...
    case BLOCK_TYPES.TEXT_INPUT:
      return {
        ...
        required: false,
        fieldName: `text_field_${Date.now()}`,
        helpText: "",
        validationType: "none",
        maxLength: "",
      };
    ...
    case BLOCK_TYPES.CHECKBOX_GROUP:
      return {
        ...
        label: "Checkbox Group",
        required: false,
        fieldName: `checkbox_group_${Date.now()}`,
        helpText: "",
