...
const availablePlaceholders = [
  ...
  {
    value: "PH@PortfolioName",
    label: "Portfolio Name",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioAddress",
    label: "Portfolio Address",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioCity",
    label: "Portfolio City",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioState",
    label: "Portfolio State",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioZip",
    label: "Portfolio Zip",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioPhone",
    label: "Portfolio Phone",
    category: "Company",
    format: "fintech",
  },
  {
    value: "PH@PortfolioEmail",
  ...
  {
    value: "PH@CustomerAddress",
    label: "Customer Address",
    category: "Customer",
    format: "fintech",
  },
  {
    value: "PH@CustomerCity",
    label: "Customer City",
    category: "Customer",
    format: "fintech",
  },
  {
    value: "PH@CustomerState",
    label: "Customer State",
    category: "Customer",
    format: "fintech",
  },
  {
    value: "PH@CustomerZip",
    label: "Customer Zip",
    category: "Customer",
    format: "fintech",
  },
  {
    value: "PH@MobilePhone",
    label: "Mobile Phone",
    category: "Customer",
    format: "fintech",
  },
...
function getElementBottomPos(element: HTMLElement): {
  top: number;
  left: number;
} {
...
export function PlaceholderDropdown({
  ...
  const groupedPlaceholders = useMemo(() => {
    return filteredPlaceholders.reduce(
      (acc, p) => {
  ...
  const dropdown = (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 10px 25px -3px rgba(0, 0, 0, 0.15), 0 4px 10px -2px rgba(0, 0, 0, 0.08)",
      }}
      ...
      <div className="border-t border-border px-3 py-1.5 text-[10px] text-muted-foreground bg-muted/50 flex-shrink-0">
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-1">
            <kbd className="inline-flex h-4 items-center rounded border bg-background px-1 font-mono text-[9px]">
              @
            </kbd>
            Trigger
          </span>
...
export function usePlaceholderTrigger(options: UsePlaceholderTriggerOptions) {
  ...
  const openDropdown = useCallback(
    (pos: { top: number; left: number }, term: string, cursorPos: number) => {
  ...
  const handleSelect = useCallback(
    (placeholder: string) => {
      if (inputElementRef.current) {
        ...
        if (
          "value" in inputElementRef.current &&
          typeof inputElementRef.current.value === "string"
        ) {
        ...
        const textBeforeCursor = text.substring(
          0,
          savedCursorPosRef.current + searchTerm.length,
        );
        const lastAtIndex = textBeforeCursor.lastIndexOf("@");
        const lastPhAtIndex = textBeforeCursor.lastIndexOf("PH@");
        const actualTriggerPos = Math.max(lastAtIndex, lastPhAtIndex);
        ...
        options.onInsert(
          placeholder,
          actualTriggerPos >= 0 ? actualTriggerPos : savedCursorPosRef.current,
        );
      }
